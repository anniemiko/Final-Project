    ...
    <BaseLayout>
      ...
      <div className="row">
        ...
        <div className="col s12 m6">
          ...
          <p className="about-p">Social relationships play a bi part in our ability to change our lives. When you tell others you are attempting something, you end up feeling accountable to live up to your word. Additionally, working on a challenge together provides both support from friends and a little healthy competition to help you reach your goals.</p>
        </div>
        <div className="col s12 m6">
